          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-6">
              <div className="bg-indigo-50 rounded-2xl px-8 py-5 text-center shrink-0">
                <div className="font-departure text-3xl text-indigo-700">5k+</div>
                <div className="text-[11px] font-semibold text-slate-500 mt-1.5 uppercase tracking-wide">Job seekers</div>
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            ...
            },
            {
              ...
              desc: "See your match score and auto-fill applications directly on LinkedIn and Indeed.",
