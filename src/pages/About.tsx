    ...
    <MarketingShell>
      ...
      <section className="py-16 sm:py-24 max-w-3xl mx-auto px-5 sm:px-8">
        ...
        <div className="space-y-5 text-slate-600 leading-relaxed">
          ...
          <p>
            Jobplotter started as a simple idea — what if one tool understood your actual experience, matched you
            against roles semantically instead of by keywords, and helped you ship a tailored, ATS-ready application in
            minutes instead of hours?
          </p>
          <p>
            Today that idea is a full platform: a vector-based matching engine that scores every job against your
            profile, an AI resume builder and reviewer, and a tracker that keeps your whole pipeline in view. One clean
            workflow, from "interested" to "offer".
          </p>
        </div>
      </section>
