...
const faqSections = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Create a free account, then either upload an existing resume or build one from scratch in the Resume Builder. Once your profile has a resume, the 'For You' feed starts matching you with relevant roles automatically."
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Instead of keyword matching, we use semantic (vector) search: your resume and each job posting are converted into embeddings, and we score how closely they align in meaning. That's why a 'Frontend Architect' role can match a 'React Specialist' resume even without identical keywords."
      },
      {
