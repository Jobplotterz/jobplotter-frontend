        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
          <div className="col-span-2 sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-slate-500 text-[13px] leading-relaxed max-w-xs">
              The intelligent way to navigate the modern job market. Plot your path to the perfect role with AI match scores, ATS-ready resumes, and application tracking.
            </p>
          </div>
